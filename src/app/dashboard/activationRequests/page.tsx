...
import { ActivationRequests } from "@/components/dashboardPages/activationRequests";

export const getUserData = async (authUser: AuthUser, lang: string, cup: string, clientsToo: boolean, salesmenToo: boolean) => {
...
const ActivationRequestsPage = async ({
    searchParams,
}: {
    ...
    return (
        <div>
            ...
            <ActivationRequests clientsInput={clients} adminsAndSalesmenInput={adminsAndSalesmen} available_cup_pricings={available_cup_pricings} available_color_pricings={available_color_pricings} />
        </div>
    )
}
