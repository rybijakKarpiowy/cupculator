			...
			<div className="block md:w-[750px] lg:w-[970px] xl:w-[1170px] h-full mr-auto ml-auto px-[15px] border-none">
				{!embed && (
					<div className="lg:float-left lg:mx-0 block">
						...
						>
							<span className="absolute w-[1px] h-[1px] -m-[1px] p-0 overflow-hidden border-0">Menu</span>
				...
				<div id="navbar" className="lg:mx-0 lg:px-0 lg:pb-0 block overflow-visible h-auto max-h-[340px] relative">
					{!embed && (
						<>
							<div className="block lg:float-right lg:-mr-[15px] ml-[59px] border-none">
								<ul className="mt-[18px] pl-0 -ml-[5px] mb-[10px] flex gap-1">
									<li className="px-[5px]">
										<Link href={`?cup=${cup}&lang=1&embed=${embed}`}>
											<Image className="align-middle overflow-clip" src={plImage} alt="pl" unoptimized />
										</Link>
									</li>
									<li className="px-[5px]">
										<Link href={`?cup=${cup}&lang=2&embed=${embed}`}>
							...
							<ul className="lg:float-right ml-[59px] mr-0 mt-[47px] mb-0 pl-0 leading-[22.4px] text-[14px]">
								...
								<li className="lg:float-left relative block">
									<Link href={`https://kubki.com.pl/Kubki.html?lang=${lang}`} className="tab">
										{lang === "1" ? "Oferta" : "Offer"}
									</Link>
								</li>
								<li className="lg:float-left relative block">
									<Link href={`https://kubki.com.pl/O_firmie2.html?lang=${lang}`} className="tab">
								...
								<li className="lg:float-left relative block">
									<Link href={`https://kubki.com.pl/Know_how.html?lang=${lang}`} className="tab">
										{lang === "1" ? "Strefa wiedzy" : "Knowledge base"}
									</Link>
								</li>
								<li className="lg:float-left relative block">
									<Link href={`https://kubki.com.pl/Kontakt.html?lang=${lang}`} className="tab">
